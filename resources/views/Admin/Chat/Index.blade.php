                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class=" py-3 flex items-start justify-start ps-3">
                                            ...
                                            <form id="deleteForm-{{ $chat->id }}" action="{{ route('admin.global-chat.destroy', ['chat' => $chat->id]) }}" method="POST" class="inline-block">
                                                @method('delete')
                                                @csrf
                                                <button type="button" onclick="confirmDelete({{ $chat->id }})" class="w-full text-center mx-auto py-2 ps-4 pe-28 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
