                ...
                <ol class="inline-flex items-center space-x-1 rtl:space-x-reverse md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Daftar Chat Global</span>
                        </div>
                    </li>
                </ol>
            </nav>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-4 py-2">
                                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300 line-clamp-2">Ikbar NJM</span>
                                        </td>
                                       
                                        <td class="px-4 py-2">Sunday 12.00</td>
                                    ...
                                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-4 py-2 lg:max-w-[200px] max-w-[150px]">
                                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300 line-clamp-2 hover:line-clamp-none">
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt sunt a ex sint nisi expedita maxime rerum mollitia distinctio iusto, eos perferendis quod, illo rem voluptate culpa laudantium voluptatum. Iusto.
                                            </span>
                                        </td>
