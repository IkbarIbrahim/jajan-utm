        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('admin.users.index') }}"
                    class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    <i
                        class="fa-solid fa-user-group text-lg text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"></i>
            ...
            <li>
                <a href="{{ route('admin.merchants.index') }}"
                    class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    <i
                        class="fa-solid fa-store text-lg text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"></i>
                    <span class="ms-3">Daftar Merchant</span>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.products.index') }}"
                    ...
                    <span class="ms-3 flex-1 whitespace-nowrap">Postingan Products</span>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.global-chat.index') }}"
                    class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    <svg class="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 20 20">
                    ...
                    <span class="ms-3 flex-1 whitespace-nowrap">Daftar Chat Global</span>
