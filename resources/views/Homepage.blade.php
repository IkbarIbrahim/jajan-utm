        ...
        <section class="hero overflow-hidden">
            ...
            <div class=" pb-[110px] pt-[120px] z-10 lg:pt-[150px] bg-cover"
                ...
                <div class="mt-4 lg:mt-[-210px] w-full z-10 absolute " >
                    <svg class="dark:fill-gray-500 fill-gray-200"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path f fill-opacity="1" d="M0,224L48,240C96,256,192,288,288,293.3C384,299,480,277,576,266.7C672,256,768,256,864,245.3C960,235,1056,213,1152,218.7C1248,224,1344,256,1392,272L1440,288L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
                </div>
        </section>
                    ...
                    <div class="w-full px-4">
                        <div class="mx-auto mb-12  text-center lg:mb-20">
                            ...
                            <p class="text-base text-black dark:text-gray-800">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim, omnis fugiat vero dolorum cum quae iure eum cumque, illum assumenda reprehenderit maiores officiis? Aliquid placeat adipisci vero consequuntur aspernatur pariatur.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mx-auto">
                ...
                <div class="w-full px-4 ">
                    ...
                    <p class="dark:text-gray-800">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Enim, sapiente eum sequi quos quibusdam officiis officia molestiae commodi optio quae minima, rerum, voluptatem doloremque voluptates iusto unde? Laborum, nulla laudantium?
                    </p>
                    </div>
                </div>
                </div>
        ...
        <section class="relative z-10 overflow-hidden bg-white dark:bg-gray-700 py-20 lg:py-[110px]">
                ...
                <div class="-mx-4 flex flex-wrap items-stretch">
                  <div class="w-full px-4">
                    <div class="mx-auto max-w-[570px] text-center">
                      ...
                      <a href="javascript:void(0)" class="inline-block rounded-md border border-transparent bg-blue-600 px-7 py-3 text-base font-medium text-white transition hover:bg-opacity-90">
                        Get Started now
                      </a>
                    </div>
                  </div>
            ...
            <div>
              <span class="absolute left-0 top-0 ">
                <svg class="fill-blue-400 dark:fill-gray-800" width="495" height="470" viewBox="0 0 495 470" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="absolute bottom-0 right-0">
                <svg class="fill-blue-400 dark:fill-gray-800" width="493" height="470" viewBox="0 0 493 470" fill="none" xmlns="http://www.w3.org/2000/svg">
