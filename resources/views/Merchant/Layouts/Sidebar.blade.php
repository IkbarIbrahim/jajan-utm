    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('merchant.index') }}" class="ms-2 flex md:me-24">
                    <span
                        class="self-center whitespace-nowrap text-xl font-semibold dark:text-white sm:text-2xl">Merchant
                        Dashboard</span>
                </a>
            </div>
                        ...
                        <ul class="py-1" role="none">
                            ...
                            <li>
                                ...
                                <button data-modal-target="passwordModal" data-modal-toggle="passwordModal"
                                    class="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">Ubah
                                    Password</button>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('merchant.preview', Auth::guard('merchant')->user()->id) }}"
                    ...
                    <span class="ms-3 flex-1 whitespace-nowrap">Preview</span>
            ...
            <li>
                <a href="{{ route('merchant.coment.index') }}"
                    class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    <svg class="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                    ...
                    <span class="ms-3 flex-1 whitespace-nowrap">Komentar</span>
                
                </a>
            </li>
            <li>
                <a href="{{ route('merchant.edit_profile.index') }}"
                    class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    <svg class="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 20 18">
                    ...
                    <span class="ms-3 flex-1 whitespace-nowrap">Edit Profile Toko</span>
                </a>
            </li>
        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{ route('merchant.password.update') }}" method="POST">
                    ...
                    <button type="submit"
                        class="w-full rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Simpan
                        Perubahan</button>
                </form>
            </div>
        </div>
